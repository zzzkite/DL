#!/usr/bin/env python3
"""
Something-Something V2 数据集处理脚本 - 256x256版本
...
class VideoProcessor:
    def __init__(self, video_dir="extracted_videos/20bn-something-something-v2", 
                 label_dir="labels",
                 output_dir="processed_data_256"):
        self.video_dir = Path(video_dir)
        self.label_dir = Path(label_dir)
        self.output_dir = Path(output_dir)
        self.target_size = (256, 256)  # 修改为256x256
            ...
            try:
                ...
                for _, row in df.iterrows():
                    sample = {
                        ...
                        'resolution': row.get('resolution', '256x256')
                    }
